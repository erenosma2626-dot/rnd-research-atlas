    ...
    <div
      ...
      className={`group relative flex flex-col p-3 rounded-2xl border transition-all duration-150 cursor-grab active:cursor-grabbing select-none ${
        isUsedInActiveCanvas
          ...
          : !item.is_own
          ? 'bg-card-bg-light dark:bg-card-bg-dark border-black/20 dark:border-white/20 hover:border-black/40 shadow-xs'
          : 'bg-card-bg-light dark:bg-card-bg-dark border-card-border-light dark:border-card-border-dark hover:border-black/30 dark:hover:border-white/30 shadow-xs hover:shadow-card'
      }`}
    >
      <div className="flex items-start justify-between gap-2 mb-2">
        <div className="flex items-center gap-2 min-w-0">
          <div className="w-6 h-6 rounded-lg bg-black/[0.04] dark:bg-white/[0.06] text-[#0A0A0A] dark:text-white flex items-center justify-center flex-shrink-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              <span className="text-xs font-serif font-medium text-text-primary-light dark:text-text-primary-dark truncate" title={item.original_filename}>
              ...
              {!item.is_own && item.added_by && (
                <span
                  className="w-4 h-4 rounded-full bg-black/[0.04] dark:bg-white/[0.06] text-black/60 dark:text-white/60 flex items-center justify-center flex-shrink-0 cursor-help"
